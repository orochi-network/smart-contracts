...
import './interfaces/IOrandManagementV3.sol';

contract OrandManagementV3 is IOrandManagementV3 {
  ...
  function _initOrandManagementV3(uint256[2] memory publickey) internal {
