...
export interface OrocleV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addOperator"
      | "fulfill"
...
export interface OrocleV2 extends BaseContract {
  connect(runner?: ContractRunner | null): OrocleV2;
  waitForDeployment(): Promise<this>;

  interface: OrocleV2Interface;
  ...
  ): TypedContractMethod<[operatorList: AddressLike[]], [void], "nonpayable">;
  getFunction(
