...
cpAbi('../artifacts/contracts/onprover/ONProver.sol/ONProver.json', './src/AbiONProver.ts');
...
cpTypes('../typechain-types/contracts/onprover/ONProver.ts', './src/ONProver.ts');
